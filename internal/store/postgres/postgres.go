...
const (
	phoneIdentityPredecessorVersion = uint(189)
	phoneIdentityMigrationVersion   = uint(190)
	// "phone190" as a signed PostgreSQL advisory-lock key. The lock spans the
	// two-stage 0189 -> identity audit -> 0190 transition across new binaries.
	phoneIdentityMigrationLockKey = int64(0x70686f6e65313930)
)
