...
// monoforumSubscriberUsersWithPeerCacheAndOverlaysStrict projects the complete
// subscriber user envelope (saved_peer plus all message references) for one
// viewer. Fan-out callers pass a preheated cache; direct RPCs use a one-shot
// cache and fail closed when any referenced user cannot be projected.
